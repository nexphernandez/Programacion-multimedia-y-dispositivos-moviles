...
surrender_response = api.model(
    "SurrenderResponse",
    {
        ...
        "winner": fields.String(description="Símbolo del ganador (el oponente)"),
    },
)
...
class MatchSurrender(Resource):
    ...
    def post(self, match_id):
        """Un jugador se rinde en la partida."""
        data = request.get_json()
        ...
        winner_symbol = match["players"][opponent_id]

        match["winner"] = winner_symbol
